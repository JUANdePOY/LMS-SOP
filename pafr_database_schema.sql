...
CREATE TABLE `attendance` (
  ...
  `scan_method` enum('barcode_scanner','camera','manual') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `scan_audit_log` (
  ...
  `barcode_scanned` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reservist_id` bigint DEFAULT NULL,
  `scan_result` enum('success','not_registered','invalid_barcode','event_inactive','duplicate','capacity_full') COLLATE utf8mb4_unicode_ci NOT NULL,
  `scan_method` enum('barcode_scanner','camera','manual') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `idx_sal_barcode` (`barcode_scanned`),
