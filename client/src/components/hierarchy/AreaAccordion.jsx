import { ChevronRight, MapPin, Users, Activity } from "lucide-react";
...
/**
 * ReadinessBar
 * Color-coded thin bar showing readiness %.
 */
...
/**
 * AreaAccordion
 * Level 1 — Area root node. Expands to show ArcenAccordion list.
 *
      ...
      >
        ...
        <div className="flex flex-1 flex-col gap-0.5 min-w-0">
          <div className="flex items-center gap-2">
            ...
            <span className="shrink-0 rounded-md border border-neutral-200 dark:border-neutral-700 bg-neutral-100 dark:bg-neutral-800 px-2 py-0.5 font-mono text-[10px] text-neutral-500 dark:text-neutral-500">
              {area.code}
            </span>
          </div>
          <span className="text-[11px] text-neutral-400 dark:text-neutral-600">
            {area.region} · {area.arcens.length} ARCEN{area.arcens.length !== 1 ? "s" : ""}
            · {totalGroups} groups · {totalSquadrons} squadrons
          </span>
        </div>
