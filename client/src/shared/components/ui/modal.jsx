...
function Modal({ open, onClose, title, children, footer }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4">
      ...
      <div className="relative z-10 w-full max-w-lg max-h-[calc(100vh-48px)] sm:max-h-[calc(100vh-64px)] flex flex-col rounded-lg bg-white shadow-xl">
        ...
        {footer && <div className="flex justify-end gap-2 border-t border-gray-200 px-4 sm:px-6 py-4 shrink-0">{footer}</div>}
      </div>
    </div>
  );
}
