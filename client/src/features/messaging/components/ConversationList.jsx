  ...
  return (
    <>
              ...
              >
                ...
                {isSuperAdmin && !isGroup && (
                  <button
                    ...
                    className="shrink-0 rounded p-1.5 text-neutral-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-500/10"
                ...
                {isSuperAdmin && isGroup && (
                  <button
                    ...
                    className="shrink-0 rounded p-1.5 text-neutral-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-500/10"
                    title="Delete forum conversation"
                  >
                    <Trash2 size={16} />
                  </button>
                )}
      ...
      <ConfirmDialog
        ...
        onCancel={() => { setShowDeleteConfirm(false); setDeletingConversationId(null); }}
        onConfirm={() => {
          if (deletingConversationId && onDeleteConversation) {
