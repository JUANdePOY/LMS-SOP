export default function GradeTable({ grades, onGrade }) {
  return (
      ...
      <table className="min-w-full text-sm">
        <thead>
          <tr className="border-b border-[var(--border)]">
            ...
            <th className="text-left px-3 py-2 font-medium text-neutral-500">Assignment</th>
            <th className="text-left px-3 py-2 font-medium text-neutral-500">Score</th>
            <th className="text-left px-3 py-2 font-medium text-neutral-500">Submitted</th>
        ...
        <tbody>
          {grades?.map((g) => (
            <tr key={g.id} className="border-b border-[var(--border)] last:border-0 hover:bg-neutral-50 dark:hover:bg-neutral-800/50">
              ...
              <td className="px-3 py-2 text-neutral-500">{g.assignmentTitle ?? ""}</td>
