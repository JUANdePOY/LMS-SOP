...
const STATUS_STYLES = {
  published: "bg-success-soft text-[var(--color-success)]",
      ...
      <div className="rounded-xl border border-neutral-200 bg-white p-4">
        <div className="flex items-start justify-between gap-3">
          <div className="flex min-w-0 items-start gap-3">
            <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-warning-soft text-[var(--color-warning)]">
              <FileText size={20} />
            </span>
