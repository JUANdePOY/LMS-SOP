...
import { Search, Plus, Edit2, Trash2, Building2, FolderTree, Loader2 } from 'lucide-react';
import { useToast } from '@/components/ui/Toast';

export default function DepartmentsPanel({ activeTab = 'departments' }) {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="overflow-hidden border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800">
          ...
          <div className="divide-y divide-neutral-100 dark:divide-neutral-700">
            {filteredDepts.length === 0 ? (
              ...
              filteredDepts.map((d) => (
                <div key={d.id} className="px-4 py-3 flex items-center justify-between hover:bg-neutral-50/50 dark:hover:bg-neutral-700/30 transition-colors">
      ...
      {showAddModal && (
        <Modal open={showAddModal} title="Add New Department" onClose={() => { setShowAddModal(false); setFormData({}); }}>
          <div className="flex flex-col gap-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input value={formData.name || ''} onChange={(e) => setFormData(prev => ({ ...prev, name: e.target.value }))} placeholder="e.g. Operations" />
              </div>
              <div>
                ...
                <Input value={formData.code || ''} onChange={(e) => setFormData(prev => ({ ...prev, code: e.target.value }))} placeholder="e.g. OPS" />
              </div>
            </div>
            <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Select value={formData.parent_department_id || ''} onChange={(e) => setFormData(prev => ({ ...prev, parent_department_id: e.target.value }))}>
              ...
              <div>
                ...
                <Select value={formData.status || 'active'} onChange={(e) => setFormData(prev => ({ ...prev, status: e.target.value }))}>
                  <option value="active">Active</option>
                  <option value="inactive">Inactive</option>
                  <option value="archived">Archived</option>
                </Select>
      ...
      {showEditModal && editingDept && (
        <Modal open={showEditModal} title="Edit Department" onClose={() => { setShowEditModal(false); setEditingDept(null); setFormData({}); }}>
          <div className="flex flex-col gap-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
